        ...
        {view === "profile" ? (
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4 flex flex-col gap-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-4">
                  ...
                  <p className="text-[10px] font-semibold tracking-wide text-gray-400 mt-3 mb-1">
                    ENTITY TYPE
                  </p>
          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto px-5 py-5">
                ...
                <div className="px-4 py-4 border-t border-gray-100">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {configuredVisa.documents.map((doc) => (
                      ...
                      <span
                        key={doc}
                        className="border border-gray-200 text-gray-700 text-xs px-2.5 py-1 rounded-lg"
                      >
                        {doc}
                      </span>
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 px-4 py-4 border-t border-gray-100">
                  ...
                  <div className="flex flex-wrap gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-semibold tracking-wide text-blue-500 mb-1">
                        AGENT PRICE (ADULT)
                      </p>
                  ...
                  <button
                    type="button"
                    className="flex items-center gap-2 bg-[#0B1120] text-white text-xs font-semibold px-4 py-2.5 rounded-lg"
                  >
              ...
              <button
                type="button"
                className="w-full flex flex-col items-center justify-center gap-2 border-2 border-dashed border-gray-300 rounded-xl py-6 mt-4 text-gray-500 hover:border-gray-400 hover:text-gray-600"
              >
